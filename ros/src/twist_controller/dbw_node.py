...
class DBWNode(object):
    def __init__(self):
        ...
        # dbw should be disable when convert to driver control to prevent accumulated pid error
    ...
    def loop(self):
        # 50Hz otherwise the automation system will shutdown for safety concern
        rate = rospy.Rate(50) 
